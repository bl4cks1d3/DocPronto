...
export class AddedPatient extends Entity {
  ...
  static loadInBlock(id: string): AddedPatient | null {
    return changetype<AddedPatient | null>(
      store.get_in_block("AddedPatient", id),
    );
  }
...
export class AddedDoctor extends Entity {
  ...
  static loadInBlock(id: string): AddedDoctor | null {
    return changetype<AddedDoctor | null>(
      store.get_in_block("AddedDoctor", id),
    );
  }
...
export class AddedHospital extends Entity {
  ...
  static loadInBlock(id: string): AddedHospital | null {
    return changetype<AddedHospital | null>(
      store.get_in_block("AddedHospital", id),
    );
  }
...
export class AddedPublicKey extends Entity {
  ...
  static loadInBlock(id: string): AddedPublicKey | null {
    return changetype<AddedPublicKey | null>(
      store.get_in_block("AddedPublicKey", id),
    );
  }
